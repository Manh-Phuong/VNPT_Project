...
const optionsCustomerGroup = [
    { value: 1, label: 'Viettel Post' },
    { value: 2, label: 'Việt Nam Spot (VNpost / EMS)' },
    { value: 3, label: 'Giao hàng Nhanh (GHN)' },
    { value: 4, label: 'Giao hàng Tiết Kiệm (GHTK)' },
    { value: 5, label: 'Kerry Express' },
];
...
function ProductCreate() {
    ...
    const [selectedCustomerGroup, setSelectedCustomerGroup] = useState({ value: 1, label: 'Viettel Post' });
    ...
    const handleOnClickSave = () => {
        if (validateInput() && formatAndValidateVariants() !== false) {
            const newProduct = {
                ...
                shippingUnit: selectedCustomerGroup.label,
    ...
    const saveProduct = async (product) => {
        try {
            const res = await ProductServices.createProduct(product, token);
                    ...
                    <div className={cx('personalInfoContent')}>
                        ...
                        <div className={cx('personalInfoContentRow')}>
                            <div className={cx('personalInfoContentCol')}>
                                <div className={cx('personalInfoTitle')}>Chọn đơn vị vận chuyển</div>
                                <Select
                            ...
                            <div className={cx('personalInfoContentCol')}>
                                ...
                                <div className={cx('personalInfoValue')}>
                                    <input
                                        ...
                                        type="text"
                                        onChange={(e) =>
                                            setWholeSalePrice(parseFloat(e.target.value.replace(/,/g, '')))
                                        }
                ...
                <div className={cx('attribute')}>
                    ...
                    <div className={cx('attributeContent')}>
                        {attributeList.map((attribute, index) => (
                            <div className={cx('attributeRow')} key={index}>
                                <span>
                                    Thuộc tính {index + 1} <span style={{ color: 'red', paddingLeft: 0 }}>*</span>{' '}
                                </span>
                                <input
                                    value={attribute}
                                    onChange={(e) => {
                                    ...
                                    <div className={cx('variantDetail')}>
                                        <div className={cx('detailGroup')}>
                                            <div className={cx('itemGroup')}>
                                                <span className={cx('labelItem')}>
                                                    Mã SKU:
                                                    {/* <LightTooltip
                                                        title={
                                                            <div>
                                                                <span>
                                                                    Mã <strong>không trùng lặp</strong> để định danh
                                                                    giữa các sản phẩm
                                                                </span>
                                                                <br></br>
                                                                <span>
                                            ...
                                            <div className={cx('itemGroup')}>
                                                <span className={cx('labelItem')}>
                                                    Barcode:
                                                    {/* <LightTooltip
                                                        title="Nếu để trống, mã Barcode sẽ được đặt trùng với mã SKU"
                                                        placement="top"
                                                    >
                                                        <ErrorOutlineIcon style={{ height: '15px', color: 'blue' }} />
                                                    </LightTooltip> */}
                                            ...
                                            <div className={cx('itemGroup')}>
                                                <span className={cx('labelItem')}>
                                                    Tồn kho:<span style={{ color: 'red' }}>*</span>
                                                </span>
                                                <input
                                                    className={cx('inputItem')}
                                                    type="text"
                                                    value={numeral(variant.quantity).format(0, 0)}
                                                    onChange={(e) => {
                                                        handleVariantChange(
                                                            index,
                                                            'quantity',
                                        ...
                                        <div className={cx('detailGroup')}>
                                            <div className={cx('itemGroup')}>
                                                ...
                                                <input
                                                    className={cx('inputItem')}
                                                    type="text"
                                                    value={numeral(variant.retailPrice).format(0, 0)}
                                                    onChange={(e) => {
                                                        handleVariantChange(
                                                            index,
                                                            'retailPrice',
                                            ...
                                            <div className={cx('itemGroup')}>
                                                ...
                                                <input
                                                    className={cx('inputItem')}
                                                    type="text"
                                                    value={numeral(variant.wholeSalePrice).format(0, 0)}
                                                    onChange={(e) => {
                                                        handleVariantChange(
                                                            index,
                                                            'wholeSalePrice',
                                            ...
                                            <div className={cx('itemGroup')}>
                                                ...
                                                <input
                                                    className={cx('inputItem')}
                                                    type="text"
                                                    value={numeral(variant.importPrice).format(0, 0)}
                                                    onChange={(e) => {
                                                        handleVariantChange(
                                                            index,
                                                            'importPrice',
                                        ...
                                        <div className={cx('detailGroup')}>
                                            {attributeList.map((attribute, indexAttb) => (
                                                <div className={cx('itemGroup')} key={indexAttb}>
                                                    <span className={cx('labelItem')}>
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => {
                                                            indexAttb === 0
                                                                ? handleVariantChange(index, 'value1', e.target.value)
                                                                : indexAttb === 1
                                                                ? handleVariantChange(index, 'value2', e.target.value)
